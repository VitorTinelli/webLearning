...
<html>
    ...
    <body>
        <div>
        <form name="formulario" method="post" action="cadastrosSofas.php" enctype="multipart/form-data">
            <div id="form">
                <h2> Cadastro dos Sofás</h2>
            ...
            <div class = "resultados">
                <?php
                    ...
                    if (isset($_POST['gravar'])){
                        ...
                        $sql = "insert into sofas (nome, descricao, preco, medida, peso, estrutura, modelo, espuma, tecido, cor, foto1) 
                                values ('$nome', '$descricao', '$preco', '$medida', '$peso', '$estrutura', '$modelo', '$espuma', '$tecido', '$cor', '$caminho_imagem1')";
                    ...
                    if (isset($_POST['alterar'])){
                        ...
                        //
                        $sql = "update sofas set descricao = '$descricao' 
                                where nome = '$nome'";
                    ...
                    if (isset($_POST['pesquisar'])){
                        ...
                        if (mysql_num_rows($resultado) == 0){
                            ...
                            while ($sofas = mysql_fetch_array($resultado)){
                                echo "Codigo: ".$sofas['codigo']."<br>";
                                echo "Nome: ".$sofas ['nome']."<br>";
                                echo "Descrição: ".$sofas ['descricao']."<br>";
                                echo "Preço: ".$sofas ['preco']."<br>";
                                echo "Medida: ".$sofas ['medida']."<br>";
                                echo "Peso: ".$sofas ['peso']."<br>";
                                echo "Estrutura: ".$sofas ['estrutura']."<br>";
                                echo "Modelo: ".$sofas ['modelo']."<br>";
                                echo "Espuma: ".$sofas ['espuma']."<br>";
                                echo "Tecido: ".$sofas ['tecido']."<br>";
                                echo "Cor: ".$sofas ['cor']."<br>";
                                echo "Foto 1:" . "<br>" . "<img src='".$sofas['foto1']."' alt='foto1' width='130' height='100'>"."<br><br>";
                            }
                        }
                    }
                ?>
